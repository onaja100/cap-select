...
export const ComparisonTable: React.FC<ComparisonTableProps> = ({ 
  ...
  return (
    <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl border border-pink-200/50 p-4 sm:p-6 hover:shadow-pink-200/50 hover:shadow-2xl transition-all duration-300">
      <div className="flex items-center mb-6 sm:mb-8">
        <div className="bg-gradient-to-r from-pink-500 via-rose-500 to-fuchsia-600 rounded-xl p-2 sm:p-2.5 mr-3 shadow-lg shadow-pink-500/50">
